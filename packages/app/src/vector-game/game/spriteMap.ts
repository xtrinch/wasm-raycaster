...
export class SpriteMap {
  ...
  constructor() {
    ...
    this.sprites = [
      ...
      [15.5, 1.5, 0, 1, SpriteType.TREE_CONE],
      [16.0, 1.8, 0, 1, SpriteType.TREE_CONE],
      [16.2, 1.2, 0, 1, SpriteType.TREE_CONE],
