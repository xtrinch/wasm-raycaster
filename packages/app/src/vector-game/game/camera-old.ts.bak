...
export class Camera {
  ...
  constructor(canvas: HTMLCanvasElement, map: GridMap) {
    ...
    this.intializeTexture(
      this.map.floorTexture,
      "floorData",
      "floorTextureRef"
    );
    this.intializeTexture(
      this.map.ceilingTexture,
      "ceilingData",
      "ceilingTextureRef"
    );
  ...
  intializeTexture(texture: Bitmap, key: string, refKey: string) {
    ...
    texture.image.onload = () => {
      ...
      (this[refKey] as WasmUint8Array).set(this[key]);
    };
  }
